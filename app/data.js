	...
	tools: [
		{
			...
			description: 'Персонализированные баннеры для каждой группы целевой аудитории, меняющиеся в зависимости от их поведения и/или предпочтений.'
		}, {
			name: 'Кастомные сегменты',
			description: 'Построение уникальных и специфических сегментов аудитории под конкретного рекламодателя / рекламную кампанию / продукт.'
		}, {
			name: 'Контекстный таргетинг',
			description: 'Работает с контекстом окружения рекламного места на основе анализа семантики страницы. Демонстрация креативов происходит на площадках, где встречаются заранее подобранные ключевые слова.'
		}, {
			name: 'Brand Safety',
			description: 'Защита бренда и его рекламных материалов от неблагоприятного информационного окружения.'
		}, {
			name: 'Ретаргетинг',
			description: 'Персонализированное обращение через баннеры к пользователям, которые уже просмотрели рекламируемый продукт, посетив сайт рекламодателя.'
		}, {
			name: 'Look-alike',
			description: 'Таргетинг, благодаря которому товар или услугу предлагают пользователям, по многим показателям похожим на существующих клиентов рекламодателя.'
		}, {
			name: 'Статистика Real-time',
			description: 'Доступ к статистике рекламной кампании в режиме реального времени.'
		}, {
			name: 'Оптимизация по CPM, CPC, CPA, CPnBV, CPS',
			description: 'Оптимизация рекламной кампании на достижение заданных рекламодателем показателей – стоимость сеанса, стоимость целевого действия и др.'
		}, {
			name: 'TV Sync',
			description: 'Технология единовременной и ситуативной синхронизации интернет-рекламы с событиями на TV, выходом собственного или конкурирующего ролика.'
		}, {
			name: 'Brand lift',
	...
	projects: [
		{
			...
			images: ['./assets/cases/infinity.jpg','./assets/cases/infinity.jpg','./assets/cases/infinity.jpg'],
